...
export function timepicker(element, args) {
  ...
  this.updateSettings = function (args) {
    ...
    this.settings.minTime = !(
      this.settings.minTime.getDate !== undefined || this.settings.minTime.getDate !== null
    )
      ? new Date(new Date().toDateString() + ' ' + this.settings.minTime)
      : new Date(new Date().toDateString() + ' 00:00');
    this.settings.maxTime = !(
      this.settings.maxTime.getDate !== undefined || this.settings.maxTime.getDate !== null
    )
