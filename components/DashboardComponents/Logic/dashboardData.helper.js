export const levelCount = ['40', '100', '200'];
export const difficultyLevel = ['Beginner', 'Competent', 'Proficient'];
...
export const statisticsCardData = [
  {
    ...
    courseName: 'Java Beginners for Enthusiasts',
    learnerCount: 45
  },
  {
    id: 2,
    ...
    courseName: 'Complete Java Programming-Beginner to Advance',
    learnerCount: 55
  }
];
