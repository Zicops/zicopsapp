      ...
      <div className="row">
        <div className="form">
          <div className="binge_setting">
            <div className="binge_setting_title">Skip Intro :</div>
            <div className="binge_setting_body">
              <div className="newline">
                ...
                <span className="after">(Mins: Secs)</span>
              </div>
              <div className="newline">
                ...
                <span className="after">(Seconds)</span>
              </div>
            </div>
          </div>
          <div className="binge_setting">
            <div className="binge_setting_title">Text Topic :</div>
            <div className="binge_setting_body">
              <div className="newline">
                <span className="label">Start Time</span>
                <input
