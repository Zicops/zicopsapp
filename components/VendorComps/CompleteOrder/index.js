...
const CompleteOrder = () => {
  return (
      <div className={`${styles.CompleteItemContainer}`}>
          ...
          <p className={`${styles.text2}`}>A new order with Order ID “123abc” has been added.Do give your feedback of service post completion and delivery of the required services.</p>
