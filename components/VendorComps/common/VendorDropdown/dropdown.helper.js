// Vendor dropdown react multi select styles
export function customSelectStyles(
  ...
  return {
    ...
    control: (provided, state) => {
      let borderStyle = '2px solid var(--white)';

      if (state?.isFocused || state?.hasValue) borderStyle = '2px solid var(--white)';
      if (state?.isDisabled) borderStyle = '2px solid var(--white)';
