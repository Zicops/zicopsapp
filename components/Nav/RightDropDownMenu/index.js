  ...
  return (
    <>
      ...
      <Button
        ...
        <Image src="/images/arrow2.png" alt="" height="20px" width="30px" />
      </Button>
      <Menu
        {...languages}
        {...preferences}
        ...
        <MenuItem onSelect={() => alert('Languages')}>
          <DropDownSubMenu
            subData={languages}
            menuIcon={LeftArrow}
            submenutext="My Details"
            arrowpositon="left"
            submenurowdirection={true}
          />
        </MenuItem>
        <MenuItem className="dropdown-submenu-justifycontent-right">My Certificates</MenuItem>
        <MenuItem className="dropdown-submenu-justifycontent-right">Dashboard</MenuItem>
        <MenuItem onSelect={() => alert('Support')}>
          <DropDownSubMenu
            subData={preferences}
            menuIcon={LeftArrow}
            submenutext="Support"
